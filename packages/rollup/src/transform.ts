...
import { parseWithQuery, readBody, isImportRequest } from '@revite/utils'
import { SourceMap, mergeSourceMap } from '@revite/services'
import { Resolver } from '@revite/services'
...
export function createBuildJsTransformPlugin(
  ...
  return {
    ...
    async transform(code, id) {
      ...
      let map: any | null = null // SourceMap
